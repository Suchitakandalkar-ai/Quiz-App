...
public class ResultFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        quizid = com.example.quizapp.Fragment.ResultFragmentArgs.fromBundle(getArguments()).getQuizid();
        currentUserId = com.example.quizapp.Fragment.ResultFragmentArgs.fromBundle(getArguments()).getUserId();
