...
import com.example.quizapp.MVVM.QuizViewModel;
...
public class DetailFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        position = com.example.quizapp.Fragment.DetailFragmentArgs.fromBundle(getArguments()).getPosition();
    ...
    public void onClick(View v) {
        ...
        com.example.quizapp.Fragment.DetailFragmentDirections.ActionDetailFragmentToQuizFragment
                action = com.example.quizapp.Fragment.DetailFragmentDirections.actionDetailFragmentToQuizFragment();
