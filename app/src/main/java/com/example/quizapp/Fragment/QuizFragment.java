...
public class QuizFragment extends Fragment implements View.OnClickListener{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        quizid = com.example.quizapp.Fragment.QuizFragmentArgs.fromBundle(getArguments()).getQuizid();
        totalNumberOfQuestions = com.example.quizapp.Fragment.QuizFragmentArgs.fromBundle(getArguments()).getTotalNumberOfQuestion();
        quizName = com.example.quizapp.Fragment.QuizFragmentArgs.fromBundle(getArguments()).getQuizname();
                ...
                .set(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            com.example.quizapp.Fragment.QuizFragmentDirections.ActionQuizFragmentToResultFragment
                                    actions = com.example.quizapp.Fragment.QuizFragmentDirections.actionQuizFragmentToResultFragment();
